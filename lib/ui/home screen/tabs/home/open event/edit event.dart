...
class _EditEventState extends State<EditEvent> {
  ...
  void didChangeDependencies() {
    ...
    final previousTitle = arguments['title1'] as String;

    titleController = TextEditingController(text: previousTitle);
          ...
          child: Column(
            children: [
              ...
              ClipRRect(
                ...
                child: Image.asset(//mapList[eventNameList[selectedindex]]!
                    args['image1']
